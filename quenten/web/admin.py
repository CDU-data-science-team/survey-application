...
admin.site.register(models.ChildAge)
admin.site.register(models.Relationship)
admin.site.register(models.Pregnant)
admin.site.register(models.ServiceUser)
admin.site.register(models.Rating)
admin.site.register(models.ChildRating)
admin.site.register(models.CommentsCode)
admin.site.register(models.ContactGeneric)
admin.site.register(models.CarerType)
